...
WebUI.setText(findTestObject('Object Repository/Page_Login/input_Username_LoginFormusername'), 'if321069')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_Login/input_Password_LoginFormpassword'), '2BMhfH5fbFA/69WsIOoxiw==')
...
WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Edit 11321069 Maria Fransiska Giawa/select_Jenjang Pendidikan AyahTidak sekolah_cc7c3e'), 
    '15', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Edit 11321069 Maria Fransiska Giawa/select_PekerjaanPegawai Negeri SipilGuruPej_fd22f4_1'), 
    '5', true)

WebUI.selectOptionByValue(findTestObject('Object Repository/Page_Edit 11321069 Maria Fransiska Giawa/select_PenghasilanKurang dari Rp. 500,000Rp_219ede_1'), 
    '15', true)
